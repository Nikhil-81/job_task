...
export default function Dashbord(){
  const dashbord_store=useSelector((store)=>store.chart)
    return (
      <>
      <div className="dash_loder"  Style={`display:${dashbord_store.chart_load?"block":"none"}`} ><div className="loder_icon_dash"> <CircularProgress   isIndeterminate color="green.300" /></div></div>
